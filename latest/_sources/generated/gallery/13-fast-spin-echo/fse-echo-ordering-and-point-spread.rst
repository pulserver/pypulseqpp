...
.. "generated/gallery/13-fast-spin-echo/fse-echo-ordering-and-point-spread.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_generated_gallery_13-fast-spin-echo_fse-echo-ordering-and-point-spread.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_generated_gallery_13-fast-spin-echo_fse-echo-ordering-and-point-spread.py:
...
.. image-sg:: /generated/gallery/13-fast-spin-echo/images/sphx_glr_fse-echo-ordering-and-point-spread_001.png
   :alt: fse echo ordering and point spread
   :srcset: /generated/gallery/13-fast-spin-echo/images/sphx_glr_fse-echo-ordering-and-point-spread_001.png
...
.. image-sg:: /generated/gallery/13-fast-spin-echo/images/sphx_glr_fse-echo-ordering-and-point-spread_002.png
   :alt: radial, shuffled
   :srcset: /generated/gallery/13-fast-spin-echo/images/sphx_glr_fse-echo-ordering-and-point-spread_002.png
   :class: sphx-glr-single-img
...
.. image-sg:: /generated/gallery/13-fast-spin-echo/images/sphx_glr_fse-echo-ordering-and-point-spread_003.png
   :alt: fse echo ordering and point spread
   :srcset: /generated/gallery/13-fast-spin-echo/images/sphx_glr_fse-echo-ordering-and-point-spread_003.png
   :class: sphx-glr-single-img
...
.. _sphx_glr_download_generated_gallery_13-fast-spin-echo_fse-echo-ordering-and-point-spread.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: fse-echo-ordering-and-point-spread.ipynb <fse-echo-ordering-and-point-spread.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: fse-echo-ordering-and-point-spread.py <fse-echo-ordering-and-point-spread.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: fse-echo-ordering-and-point-spread.zip <fse-echo-ordering-and-point-spread.zip>`
